...
{
    [Serializable]
    public class Inspect_MapID_Outside : ROI
    {
        public Inspect_MapID_Outside() 
        {
            Color = Color.Red;
            Type = RegionType.MapID_Outside;
        }
        public override void Load(BinaryReader fs)
        {
            ...
            {
                ChildRegion.Add(new Inspect_MapID_Outside());
        ...
        {
            Inspect_MapID_Outside rgn = new Inspect_MapID_Outside()
            {                X = x,
                Y = y,
                Width = width,
                Height = height
