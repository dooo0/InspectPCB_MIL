...
{
    [Serializable]
    public class Inspect_NoInspectArea_Inside : ROI
    {
        public Inspect_NoInspectArea_Inside()
        {
            Color = Color.Brown;
            Type = RegionType.NoInspect_Inside;
        }
        ...
        public override void Load(BinaryReader fs)
        {
            ...
            {
                ChildRegion.Add(new Inspect_NoInspectArea_Inside());
        ...
        {
            Inspect_NoInspectArea_Inside rgn = new Inspect_NoInspectArea_Inside()
            {
                X = x,
                Y = y,
                Width = width,
